...
const App = (() => {
  ...
  function renderCalibrate() {
    root.innerHTML = h`
      ...
      <section class="panel">
        ...
        <p class="hint">The original study trained at 40cm — roughly a comfortable reading distance. Keep this consistent between sessions.</p>
  ...
  function renderAssessDiscrim() {
    root.innerHTML = h`
      ...
      <div class="canvas-wrap"><canvas id="stim-canvas"></canvas></div>
      <p class="progress-text">Which side is higher contrast (more visible)?</p>
      <div class="response-row">
